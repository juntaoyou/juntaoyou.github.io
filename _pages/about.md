...
Hi, I'm Juntao You (尤俊韬). I am currently a Ph.D. student at the **University of Science and Technology of China (USTC)**, where I also received my Bachelor's degree in Artificial Intelligence. I am fortunate to be advised by **Prof. Fuli Feng** and mentored by **Yang Zhang** at the USTC Lab of Data Science. My research focuses on **LLM Personalization** — understanding and enhancing how large language models can capture and adapt to individual user preferences.
...
\1. **Juntao You\***, Xiaoyan Zhao\*, Yang Zhang, Moxin Li, Yuxin Chen, Fuli Feng, Hong Cheng, Xiangnan He, Tat-Seng Chua. "How Are Your Preferences Encoded? Neuron-level Mechanisms of LLM Personalization." *Under Review*, 2025.

\2. Xiaoyan Zhao\*, **Juntao You\***, Yang Zhang, Wenjie Wang, Hong Cheng, Fuli Feng, See-Kiong Ng, Tat-Seng Chua. "[NextQuill: Causal Preference Modeling for Enhancing LLM Personalization](https://iclr.cc/virtual/2026/poster/10006635)." *International Conference on Learning Representations (ICLR)*, 2026.
